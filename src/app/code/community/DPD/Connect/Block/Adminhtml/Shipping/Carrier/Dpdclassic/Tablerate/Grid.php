...
/**
 * Class DPD_Connect_Block_Adminhtml_Connect_Carrier_Dpdclassic_Tablerate_Grid
 */
class DPD_Connect_Block_Adminhtml_Connect_Carrier_Dpdclassic_Tablerate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Website filter
     *
