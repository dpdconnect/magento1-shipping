...
/**
 * Class DPD_Connect_Model_Mysql4_Dpdclassic_Tablerate_Collection
 */
class DPD_Connect_Model_Mysql4_Dpdclassic_Tablerate_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     * main table name
     *
