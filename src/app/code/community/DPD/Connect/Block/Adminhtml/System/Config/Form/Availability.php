...
/**
 * Class DPD_Connect_Block_Adminhtml_System_Config_Form_Availability
 */
class DPD_Connect_Block_Adminhtml_System_Config_Form_Availability extends Mage_Adminhtml_Block_System_Config_Form_Field
{
