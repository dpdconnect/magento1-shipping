...
/**
 * Class DPD_Connect_Helper_Data
 */
class DPD_Connect_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    {
        $gmapsKey = Mage::getStoreConfig('carriers/dpdparcelshops/google_maps_backend_api');
